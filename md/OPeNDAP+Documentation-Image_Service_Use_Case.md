**Point Of Contact:** *[Tim Pugh, Aus. BOM](User:Tpugh "wikilink")*
...
An image service for a data catalog service
...
This use case is to describe a "quick-look" data service so an external
user or service may receive an image of the data.
...
An image service embedded within the Hyrax server would provide an
additional service to generate images of specific data sets within an
OPeNDAP service, and return compressed images of the data to an external
user or service.
...
A user may request a quick look at a specific data set and indices to
receive a compressed image or data array for visual presentation before
requesting larger amounts of data.

<!-- -->


In addition to the user, an external service such as a data catalog, may
request a quick look at a specific data set for visual presentation.
