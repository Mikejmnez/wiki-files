...
2\. Restart Tomcat. This will cause the S3 DAP service to start and
...
This allows us to easily make a hierarchical directed graph style
...
So for example, an S3 bucket mapped by the configuration to the context
